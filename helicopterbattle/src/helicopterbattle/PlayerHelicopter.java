...
public class PlayerHelicopter {
    ...
    // Helicopter rockets.
    private final int numberOfRocketsInit = 100;
    ...
    private void LoadContent()
    {
        ...
        helicopterRearPropellerAnim = new Animation(helicopterRearPropellerAnimImg, 54, 54, 4, 30, true, xCoordinate + offsetXRearPropeller, yCoordinate + offsetYRearPropeller, 0);
    }
    ...
    public void Update()
    {
    	// Lock helicopter on Frame
    
    	if(xCoordinate + offsetXMachineGun >= Framework.frameWidth) 
    		movingXspeed = -1;
    	else if(xCoordinate<=0)
    		movingXspeed = 1; 
    	if(yCoordinate <= 0)
    		movingYspeed = 1;
    	else if(yCoordinate + offsetYMachineGun >= Framework.frameHeight)
    		movingYspeed = -0.8;
