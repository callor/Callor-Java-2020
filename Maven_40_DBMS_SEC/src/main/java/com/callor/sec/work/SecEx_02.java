...
public class SecEx_02 {
	...
	public static void main(String[] args) {
		...
		String encPasword = pbEnc.encrypt(planPassword);
		
		System.out.printf("username %s, %s\n",planUserName,encUserName);
		System.out.printf("password %s, %s\n",planPassword,encPasword);
		
		
		/*
		 * username OxqrjB3nNKrYZ/EREnoAEg==
		 * password rS474HQX/VYR0INqmKApWg==
		 */
