...
public class DBConnection {
	...
	static {
		...
		/*
		 * USER : user4 -> z5haakCaa8Y/0BwXdYeDYw==
		 * PASSWORD : user4 -> GpbuKiNtDQGwrkIyFRGHcw==
		 * 
		 */
		...
		prop.put("username", pbeEnc.decrypt("z5haakCaa8Y/0BwXdYeDYw=="));
		prop.put("password", pbeEnc.decrypt("GpbuKiNtDQGwrkIyFRGHcw=="));
