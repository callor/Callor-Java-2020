	...
	<div id="join_wrap" class="divsize">
		<form action="memberupdateplay.bizpoll" method="POST" name="frm_mem" id="frm_mem">
			<div class="div_input" id="fcryan_id">
				<input type="text" placeholder="아이디" class="input_join input_msg" id="inputid" name="inputid" value="${sessionScope.loginUser.id}" readonly="readonly">
				<span class="error">필수 정보입니다.</span>
			</div>
			<div class="div_input" id="fcryan_name">
				<input type="text" placeholder="이름" class="input_join input_msg" id="inputname" name="inputname" value="${sessionScope.loginUser.name}">
				<span class="error">필수 정보입니다.</span>
			</div>
			<div class="div_input" id="fcryan_phone">
				<input type="text" placeholder="핸드폰번호(-없이 입력하세요.)" class="input_join input_msg" id="inputphone" name="inputphone" maxlength="11" value="${sessionScope.loginUser.phone}">
				<span class="error">필수 정보입니다.</span>
			</div>
			...
			<div class="div_input" id="fcryan_addr">
				<input type="text" class="addr input_msg addrbtn" id="sample6_postcode" name="zipcode" placeholder="우편번호" readonly="readonly" value="${sessionScope.loginUser.zipcode}">
				<input type="button" id="addr_btn" class="addr" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
				<input type="text" class="addr input_msg addrbtn" id="sample6_address" placeholder="주소" name="addr1" readonly="readonly" value="${sessionScope.loginUser.addr1}">
				<input type="text" class="addr input_msg" id="sample6_address2" placeholder="상세주소" name="addr2" value="${sessionScope.loginUser.addr2}">
				<span class="error">필수 정보입니다.</span>
			</div>
			<div class="btn_double_area">
				<span><a href="index.bizpoll" class="btn_type btn_default">취소</a></span>
				<span><a href="#" class="btn_type btn_agree">회원수정</a></span>
			</div>
		</form>
	</div>
